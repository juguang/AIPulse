...
1. **Classification/Tagging**
   - Purpose: Determine article category (模型/产品/行业/研究/工程) and extract
...
- 研究：学术论文/研究成果（必须是正式的学术论文、预印本或有明确研究方法/实验验证的原创研究，非 AI 类的科普/新闻不要归为此类）
- 工程：工程实践/开发教程（如编码技巧、提示工程、部署指南、系统架构、案例分析等）
...
输出格式为 JSON，无其他文字：
{{"category": "模型/产品/行业/研究/工程", "tags": ["tag1", "tag2"], "language": "zh/en"}}"""
